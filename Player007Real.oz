...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   in
      ...
      L1 = {New Tk.label tkInit(parent:W
				text:ID.name#' has move to the '#Direction)}
   ...
   in
      ...
      L1 = {New Tk.label tkInit(parent:W
				text:ID.name#' is back to the surface')}
   ...
   in
      ...
      L1 = {New Tk.label tkInit(parent:W
				text:ID.name#' '#'has charge a '#KindItem)}
   ...
   in
      W = {New Tk.toplevel tkInit(title:'Drone result')}
      L1 = {New Tk.label tkInit(parent:W
				text:ID.name#'       '#Answer.x#','#Answer.y)}
   ...
   in
      ...
      L1 = {New Tk.label tkInit(parent:W
				text:ID.name#' has '#LifeLeft#' life left')}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   fun{StartPlayer Color ID}
      ...
      Id
   in
      Id = id(id:ID color:Color name:real)
      Port = {NewPort Stream}
